...
alias aseprite="/opt/aseprite/Aseprite.exe"
alias start="~/dev/bash_scripts/startProject.sh"
alias gpt="python ~/dev/scripts/gpt.py"
alias wnvim="nvim ~/Documents/notes/wiki/index.wiki"
